...
def pad_string(string, maxLen, subASCII=False):
...
iat_value_reversed = iat_value[::-1]
iat_value_reversed_value = pad_string(iat_value_reversed, maxIatValueLen)
iat_value_reversed_not_ascii_value = pad_string(iat_value_reversed, maxIatValueLen, True)
...
nonce_value_reversed_not_ascii_value = pad_string(nonce_value_reversed, maxNonceValueLen, True)
...
L_byte_encoded_value = pad_string(L_byte_encoded, 8)
...
padding_without_len_bytes_value = pad_string(padding_without_len_bytes, 64)
...
jwt_value = pad_string(unsigned_b64_jwt_string_sha_padded, jwt_max_len)
